# ⚡ Arduino Uno ADS-B 1090MHz Mode-S Aircraft Telemetry Pulse Decoder
...
Aviation receiver measuring 1090MHz demodulated PPM pulses, validating CRC-24 polynomial checksums, and decoding Mode-S squawk, altitude, and callsigns to LCD.
...
3. Pastikan dependensi pustaka terpasang via Library Manager:
   ...
   * `Wire` & `SPI`
   * `EEPROM`
4. Buka berkas [`arduino-uno-adsb-flight-decoder.ino`](./arduino-uno-adsb-flight-decoder.ino).
