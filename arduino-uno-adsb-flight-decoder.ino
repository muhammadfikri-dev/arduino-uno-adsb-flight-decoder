/**
 * =========================================================================================
 * Project     : Arduino Uno ADS-B 1090MHz Mode-S Aircraft Telemetry Pulse Decoder
 * Platform    : Arduino Uno / ATmega328P
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Aviation receiver measuring 1090MHz demodulated PPM pulses, validating CRC-24 polynomial checksums, and decoding Mode-S squawk, altitude, and callsigns to LCD.
 * =========================================================================================
 */
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" Arduino Uno ADS-B 1090MHz Mode-S Aircraft Telemetry Pulse Decoder"));
